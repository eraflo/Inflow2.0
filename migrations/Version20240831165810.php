 ...
 */
final class Version20240831165810 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE users (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(50) NOT NULL, password VARCHAR(255) NOT NULL, username VARCHAR(20) NOT NULL, url VARCHAR(200) DEFAULT NULL, roles JSON NOT NULL COMMENT \'(DC2Type:json)\', follows_count INT DEFAULT NULL, followers_count INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE has (users_id INT NOT NULL, roles_id INT NOT NULL, INDEX IDX_C6F39EA67B3B43D (users_id), INDEX IDX_C6F39EA38C751C4 (roles_id), PRIMARY KEY(users_id, roles_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
